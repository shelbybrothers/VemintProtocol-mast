...
import { baseERC6909-Development-Kit } from 'wagmi/chains';
import { coinbaseWallet } from 'wagmi/connectors';

const config = createConfig({
  chains: [baseERC6909-Development-Kit],
  connectors: [
    coinbaseWallet({
  ...
  ssr: true,
  transports: {
    [baseERC6909-Development-Kit.id]: http(),
  },
});
    ...
    <WagmiProvider config={config} initialState={props.initialState}>
      <QueryClientProvider client={queryClient}>
        <OnchainKitProvider
          ...
          chain={baseERC6909-Development-Kit}
          config={{
            appearance: {
              mode: 'auto',
              theme: 'base',
